...
public class KeyActor extends BaseActor {
    ...
    public KeyActor(Body body, String keyType) {
        ...
        if (keyType.equalsIgnoreCase(KeyModel.KEY_GOLD)) {
            mKey = Gizmo.assetManager.get("res/image/object/key_gold.png", Texture.class);
        }
        else if (keyType.equalsIgnoreCase(KeyModel.KEY_BRONZE)) {
            mKey = Gizmo.assetManager.get("res/image/object/key_bronze.png", Texture.class);
        }
        else if (keyType.equalsIgnoreCase(KeyModel.KEY_BLOOD)) {
            mKey = Gizmo.assetManager.get("res/image/object/key_blood.png", Texture.class);
        }
        else if (keyType.equalsIgnoreCase(KeyModel.KEY_BLACK)) {
            mKey = Gizmo.assetManager.get("res/image/object/key_black.png", Texture.class);
        }
